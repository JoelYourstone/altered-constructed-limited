...
import UploadImportedCards from "./UploadImportedCards";
...
export default function ImportCsvModule() {
  ...
  const getExistingCardsForSet = useCallback(
  ...
  const calculateBoosterSummary = useCallback(
    (cards: ParsedCard[]): BoosterSummary[] => {
      // Group cards by set
    ...
    [seasonSets, getExistingCardsForSet]
  );
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="px-4 py-6 max-w-2xl mx-auto">
        {startImport ? (
          <UploadImportedCards summaries={summary} />
        ) : (
          <>
              ...
              <div className="mt-6 space-y-4">
                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="text-xs text-foreground/60 mt-1">
                          In vault: {setSummary.existingCardsInVault} cards /
                          Max:{" "}
                    ...
                    <div className="mt-3">
                      <div className="flex items-center justify-between text-xs text-foreground/60 mb-1">
                        ...
                        <span>
                          ...
                          {setSummary.totalCards} cards in boosters
                        </span>
                      </div>
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    ...
                    disabled={
                      summary.reduce((sum, s) => sum + s.remainingCards, 0) >
                        0 || summary.some((s) => s.wouldExceedLimit)
                    }
                    onClick={() => {
                      setStartImport(true);
                    }}
