    ...
    switch (card.rarity.toUpperCase()) {
      ...
      case "RARE":
        ...
        return {
          ...
          filter: "drop-shadow(0 0 1px rgba(255, 255, 255, 1)) drop-shadow(0 0 2px rgba(255, 255, 255, 0.8)) drop-shadow(0 0 4px rgba(59, 130, 246, 0.3))",
      ...
      case "UNIQUE":
        ...
        return {
          ...
          filter: "drop-shadow(0 0 1px rgba(255, 255, 255, 1)) drop-shadow(0 0 2px rgba(255, 255, 255, 0.9)) drop-shadow(0 0 6px rgba(245, 158, 11, 0.6)) drop-shadow(0 0 10px rgba(245, 158, 11, 0.4))",
    ...
    <div className="relative overflow-hidden rounded-lg border border-black/[.08] dark:border-white/[.145] hover:border-black/[.15] dark:hover:border-white/[.25] transition-all">
      ...
      {gemStyle && (
        <>
          ...
          {(card.rarity.toUpperCase() === "UNIQUE" || card.rarity.toUpperCase() === "RARE") && (
            <div
              ...
              style={{
                ...
                filter: card.rarity.toUpperCase() === "UNIQUE" ? "blur(1px)" : "blur(3px)",
              }}
            />
          )}
        </>
